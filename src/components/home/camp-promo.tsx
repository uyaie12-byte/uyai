...
export function CampPromo() {
  return (
    <section className="relative overflow-hidden border-b-[3px] border-ink bg-red text-paper">
      ...
      />
      <Reveal className="relative mx-auto flex max-w-[1400px] flex-col gap-8 px-5 py-14 sm:px-8 sm:py-20 md:flex-row md:items-end md:justify-between">
        <div>
        ...
        <Link
          ...
          className="btn-press inline-flex w-fit shrink-0 items-center gap-2 border-2 border-ink bg-paper px-6 py-3 font-mono text-sm font-semibold uppercase tracking-[0.15em] text-ink shadow-[3px_3px_0_var(--ink)]"
        >
